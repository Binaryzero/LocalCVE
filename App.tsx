...
const App: React.FC = () => {
  ...
  const fetchData = useCallback(async () => {
    try {
      ...
      if (cvesRes.status === 'fulfilled' && cvesRes.value.ok) {
        setCves(await cvesRes.value.json());
      }
  ...
  const renderContent = () => {
    ...
    switch (activePage) {
      case 'dashboard':
        return <Dashboard cves={cves} alerts={alerts} onNavigate={setActivePage} />;
      case 'cves':
        return <CveList cves={cves} onSaveWatchlist={handleSaveWatchlist} />;
      case 'watchlists':
      ...
      case 'alerts':
        return <Alerts alerts={alerts} onMarkRead={handleMarkAlertRead} onDelete={handleDeleteAlert} />;
      default:
        return <Dashboard cves={cves} alerts={alerts} onNavigate={setActivePage} />;
    }
  };
